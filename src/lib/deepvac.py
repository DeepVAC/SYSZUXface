...
class DeepVAC(object):
    ...
    def process(self):
        for rec in self.getRecord():
            start_time = time.time()
            elapsed_time = time.time() - start_time
            LOG.log(LOG.S.I, "elapsed time of process rec {}".format(elapsed_time) )

if __name__ == "__main__":
    raise Exception("You need subclass DeepVAC and reimplement the functions.")